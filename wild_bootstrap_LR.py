...
from kerpy_master.kerpy import LinearKernel
from kerpy_master.kerpy import GaussianKernel
from kerpy_master.kerpy import PolynomialKernel


def wild_bootstrap_test_logrank_covariates(x, z, d, kernel_x, kernel_z, alpha=0.05, seed=1,
                                           num_bootstrap_statistics=1999, print_score=False):
